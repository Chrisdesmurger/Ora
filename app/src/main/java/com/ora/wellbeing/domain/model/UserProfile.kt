 ...
 * @property createdAt Timestamp de création du compte (Firestore Timestamp → Date)
 * @property updatedAt Timestamp de dernière mise à jour (Firestore Timestamp → Date)
...
class UserProfile {
    ...
    // Firestore stores timestamps as Timestamp objects, which auto-convert to Date
    ...
    constructor(
        ...
        createdAt: Date? = null, // FIX(build-debug-android): Changed from Long? to Date?
    ...
    companion object {
        ...
        fun createDefault(uid: String, firstName: String? = null, email: String? = null): UserProfile {
            return UserProfile(
                ...
                email = email,
                planTier = "free",
                createdAt = Date(), // FIX(build-debug-android): Changed from System.currentTimeMillis() to Date()
                locale = null
            )
        }
    }
    ...
    fun copy(
        ...
        createdAt: Date? = this.createdAt, // FIX(build-debug-android): Changed from Long? to Date?
