...
fun ProfileEditScreen(
    onNavigateBack: () -> Unit,
    onNavigateToEmailPreferences: () -> Unit = {},
    ...
    Scaffold(
        ...
        if (uiState.isLoading) {
            ...
            Column(
                ...
                // NEW (Issue #55): Email Preferences Navigation
                NavigationRow(
                    title = stringResource(R.string.profile_edit_email_preferences),
                    description = stringResource(R.string.profile_edit_email_preferences_desc),
                    icon = Icons.Default.Email,
                    onClick = onNavigateToEmailPreferences
                )
...
/**
 * Navigation row for screens that navigate to another destination
 * Issue #55: Added for Email Preferences navigation
 */
@Composable
